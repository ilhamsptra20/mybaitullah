...
const TawafLiveJoin = ({ navigation }) => {
  ...
  const checkTextInput = () => {
    ...
    if (isValid) {
      ...
      navigation.replace('TawafRoom', { idRoom, role: "audience", periodDate, periodTime, hostName, channelName, channelCode, passCode });
    }
  };
      ...
      >
        ...
        <View style={[BaseStyle.alignItemsCenter, ({ width: '80%' })]}>
          <View>
            ...
            <Text style={[BaseStyle.MaisonBold, BaseStyle.textWhite, BaseStyle.textXL1]}>Gabung Tawaf Live Room</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <View style={[BaseStyle.wrap, BaseStyle.relative, ({ top: headerHeight * -0.4 })]}>
          <View style={[BaseStyle.BgWhite, BaseStyle.shadow, BaseStyle.p20, BaseStyle.radius10, BaseStyle.mb20]}>
            <Text style={[BaseStyle.MaisonBook, BaseStyle.textGray300, BaseStyle.textXS1, BaseStyle.mb10]}>Isi form berikut untuk gabung channel tawaf live</Text>
