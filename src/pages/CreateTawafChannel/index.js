...
const CreateTawafChannel = ({ navigation }) => {
      ...
      >
        ...
        <View style={[BaseStyle.wrap, BaseStyle.relative, ({ top: headerHeight * -0.4 })]}>
          <View style={[BaseStyle.BgWhite, BaseStyle.shadow, BaseStyle.p20, BaseStyle.radius10, BaseStyle.mb20]}>
            <Text style={[BaseStyle.MaisonBook, BaseStyle.textGray300, BaseStyle.textXS1, BaseStyle.mb10]}>Isi form berikut untuk membuat channel tawaf live Anda</Text>
...
export default CreateTawafChannel
