...
const DatePickerInput = ({lable, placeholder, placeholderColor='#696B6B', icon, width='100%', borderColor= '#B1B1BC', onChange, ...restProps}) => {
  ...
  return (
    <View style={[styles.container(width, borderColor), BaseStyle.radius10]}>
      ...
      <DatePicker
        ...
        minimumDate={restProps.minimumDate} // Tambahkan properti ini
      />
