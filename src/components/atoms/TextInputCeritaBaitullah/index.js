...
const TextInputCeritaBaitullah = ({placeholder, placeholderColor='#696B6B', icon, width='100%', keyboardType, value, onChange, ...restProps}) => {
  return (
...
export default TextInputCeritaBaitullah
